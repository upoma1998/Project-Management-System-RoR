...
* Project Description:
   ...
   2. There are two types of plans- Free Project Plan and Paid Project Plan. An organization can create only one project under the free       plan and can create multiple projects under the paid plan.
...
* Requirements Implemented:
   ...
   2. Authorization of Organization and adding controller functions to perform operations on free projects, paid projects and member          modules.
   ...
   4. Authorization of Member
   
* Requirements left:
   1. Performing the swith of plans between free project and paid project plans.
   2. Adding member controller functions to perform operations on creation, assignment, update and deletion of tasks.
      
* Ruby version 3.2.0

* Installation:
   As the project has been dockerized, The following commands will run the project:
   1. docker build .
   2. docker compose up
...
* Postman Collection:
  https://drive.google.com/file/d/1BGHU3qIWNks50fdzK64ttOYVDY9_DSw_/view?usp=sharing
